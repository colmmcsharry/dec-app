...
export const SUPPLEMENTAL_RESOURCES: Record<string, SupplementalResource[]> = {
  ...
  "sleep:1159439753": [
    {
      ...
      pdfKey: "1-week-for-better-sleep",
      description:
  ...
  "morning-routines:1162887336": [
    {
      ...
      pdfKey: "your-go-to-rise-shine-routine",
      description:
  ...
  "mindfulness:1162888402": [
    {
      ...
      pdfKey: "best-creative-solutions",
      description:
  ...
  "fuel-2-perform:1162890726": [
    ...
    },
    {
      ...
      pdfKey: "food-journal-continuation",
      description:
  ...
  "fuel-2-perform:1162890753": [
    {
      ...
      pdfKey: "hydrating-for-performance",
      description:
  ...
  "stress-management:1162891025": [
    {
      ...
      pdfKey: "assertiveness-action-plan",
      description:
