...
export default function VideoDetailScreen() {
  ...
  const [openingResourceKey, setOpeningResourceKey] = useState<string | null>(
    null,
  );
  ...
  const headerFg = lightOnArt ? "#FFFFFF" : isDark ? "#ECEDEE" : "#2C3E50";
  ...
  }, [completionCountdown, goToNextModule, nextModuleInfo, showCompletion]);
      ...
      <View style={{ flex: 1, backgroundColor: pageBackground }}>
        ...
        >
          ...
          <View style={styles.infoSection}>
            {canChainToNextVideo ? (
              <View
                style={[styles.autoplayRow, isDark && styles.autoplayRowDark]}
              >
                <View style={styles.autoplayCopy}>
                  ...
                  {Platform.OS === "ios" && isLowPowerMode ? (
                    ...
                    >
                      Autoplay may not work while iPhone's Low Power Mode is on
                    </Text>
                  ) : null}
                </View>
                <Switch
            ...
            {watched ? (
              <View style={styles.watchedStatus} accessibilityRole="text">
                <Check
                  size={18}
            ...
            {supplementalResources.length > 0 && (
              <View style={styles.resourcesSection}>
                <Text
                  style={[styles.resourcesTitle, isDark && styles.textDark]}
                >
          ...
          >
            ...
            >
              ...
              {nextModuleInfo ? (
                <>
                  <View
                    style={styles.completionCountdownWrap}
                    pointerEvents="none"
                  >
                    <Text
                      style={[
                  ...
                  >
                    <View
                      pointerEvents="none"
                      style={styles.completionButtonInner}
                    >
                ...
                >
                  <Text
                    style={styles.completionButtonText}
                    pointerEvents="none"
                  >
                    Done
                  </Text>
